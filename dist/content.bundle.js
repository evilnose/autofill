...
var runProcess = __webpack_require__(/*! ./runProcess.js */ "./src/content/runProcess.js");
...
var getElement = __webpack_require__(/*! ./getElement.js */ "./src/content/getElement.js");
var Commands = __webpack_require__(/*! ./commands.js */ "./src/content/commands.js");
...
module.exports = function runProcess(process, autoRoute, sendRes) {
  ...
  getDelayPromise(Atfl.PAGE_INIT_DELAY).then(function () {
    return getCommandPromiseChain(process, 0);
  }).then(processComplete).catch(handleError).finally(function () {
    return processCleanup(!autoRoute ? sendRes : null);
  });
};
...
function getCommandPromiseChain(p) {
  ...
  var _loop = function _loop(i) {
    promise = promise.then(function () {
      return getCommandPromise(p[i], i);
    });
  };
...
function getCommandPromise(prc, i) {
  if (Array.isArray(prc)) {
    ...
    p = p.then(function () {
      return getFindElementRetryPromise(prc.target, prc.action);
    }).then(function (ele) {
      return getActionRetryPromise(getCommand(prc.action), ele, prc);
    });

    p = p.then(function () {
      Atfl.skipPenalty = 0;
    }) // clear penalty on successful action
    .catch(function (err) {
      return skipAction(err, prc.action);
    });
...
function retryAction(func, ele, prc, dIdx, resolve, reject) {
  ...
  if (func(ele, prc.val)) {
    ...
    setTimeout(function () {
      return retryAction(func, ele, prc, dIdx + 1, resolve, reject);
...
function retryFindElement(path, action, dIdx, resolve, reject) {
  ...
  if (ele.length) {
    ...
    setTimeout(function () {
      return retryFindElement(path, action, dIdx + 1, resolve, reject);
