...
/******/ 	return __webpack_require__(__webpack_require__.s = "./content/content.main.js");
/******/ })
/************************************************************************/
/******/ ({
...
var getCommandFn = __webpack_require__(/*! ./getCommandFn.js */ "./content/getCommandFn.js");
var getElement = __webpack_require__(/*! ./getElement.js */ "./content/getElement.js");
var constants = __webpack_require__(/*! ./constants.js */ "./content/constants.js");
  ...
  runCommand: function runCommand(cmd) {
    ...
    switch (cmd.action) {
      case 'try':
        ...
        break;
      case 'wait':
        getDelayPromise(cmd.target || constants.DEFAULT_WAIT_DELAY).then(handleActionSuccess).catch(handleActionFailure);
        break;
      default:
        getFindElementRetryPromise(cmd.target).then(function (ele) {
...
function retryFindElement(path, dIdx, resolve, reject) {
  ...
  if (ele.length) {
    ...
    setTimeout(function () {
      return retryFindElement(path, dIdx + 1, resolve, reject);
...
function retryAction(actionFn, ele, cmd, dIdx, resolve, reject) {
  ...
  if (actionFn(ele, cmd.val)) {
    ...
    setTimeout(function () {
      return retryAction(actionFn, ele, cmd, dIdx + 1, resolve, reject);
...
var actionProcessor = __webpack_require__(/*! ./actionProcessor.js */ "./content/actionProcessor.js");
...
var Commands = {
  ...
  doType: function doType(ele, val) {
    ele.focus();
    ele.val(val);
    // node.value = '';
    // $(node).sendkeys(val);
  ...
  doWaitForElementPresent: function doWaitForElementPresent(ele) {
    // getElement has already ensured the existense of element
    return !!ele;
  },

  // This is an immediately invoked function (without retries)
  doAssertElementPresent: function doAssertElementPresent(target) {
...
var BY_INDICATOR = '='; /* globals document XPathResult */
...
module.exports = function getElement(path) {
  ...
  switch (selectBy) {
    case 'id':
      ...
      return (0, _jquery2.default)("#" + target);
    case 'css':
      console.log('Finding element by css: ' + target);
      console.log((0, _jquery2.default)(target));
      return (0, _jquery2.default)(target);
    default:
